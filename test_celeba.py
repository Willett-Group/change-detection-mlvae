...
config = {
    'experiment_name': 'dfcvae_person_change_50epochs',
    'N': 30,
    'T': 10,
    'iterations': 2
}
...
for i in range(ds.n):
    ...
    grid = make_grid(torch.cat([X, g1_reconstructions_true, g2_reconstructions_true]), nrow=ds.T)
